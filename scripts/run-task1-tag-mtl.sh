...
python src/train.py \
    ...
    --train ~/sigmorphon/2019/task1/$pair/$highreslang-train-high \
            ~/sigmorphon/2019/task1/$pair/$lowreslang-train-low  \
    --dev ~/sigmorphon/2019/task1/$pair/$lowreslang-dev \
    ...
    --arch $arch --estop 1e-8 --epochs 50 --bs 20 --mtl
